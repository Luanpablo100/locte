        ...
        <div class="div-content">
            <table class="tabela-dados">
                ...
                <tr>
                  ...
                  <td>Hoje</td>
                  <td>15:30</td>
                  <td><div class="actions-div" ><img src="Img/correct.png" alt="" class="action-button" onclick="alert('Confirmar a reserva?')"><img src="Img/erro.png" alt="" class="action-button" onclick="alert('Cancelar a reserva?')"></div></td>
                </tr>
                <tr>
                  <td>Manoela Silva</td>
                  <td>Fiat Mobi</td>
